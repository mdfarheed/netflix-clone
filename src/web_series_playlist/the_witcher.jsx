...
const The_Witcher = () => {
    ...
    return (
        <>
            ...
            {seasonconut != 2 && seasonconut != 3 && count1 != 2 && count1 != 3 && count1 != 4 && count1 != 5 && count1 != 6 && count1 != 7 && count1 != 8 &&
                <>
            ...
            {count1 == 0 && seasonconut == 0 &&
                    <h5 class="text-white mb-3"> The Witcher | Season 1 | Episode 1</h5>
                }
                {seasonconut != 2 && seasonconut != 3 &&  count1 >= 1 &&
                    <h5 class="text-white mb-3"> The Witcher | Season 1 | Episode {count1}</h5>
                }
                {count2 == 0 && seasonconut == 2 &&
                    <h5 class="text-white mb-3"> The Witcher | Season 2 | Episode 1</h5>
                }
                {seasonconut != 0 && seasonconut != 1 && seasonconut != 3 && count2 >= 1 &&
                    <h5 class="text-white mb-3"> The Witcher | Season 2 | Episode {count2}</h5>
                }
                {count3 == 0 && seasonconut == 3 &&
                    <h5 class="text-white mb-3"> The Witcher | Season 3 | Episode 1</h5>
                }
                {seasonconut != 0 && seasonconut != 1 && seasonconut != 2 && count3 >= 1 &&
                    <h5 class="text-white mb-3"> The Witcher | Season 3 | Episode {count3}</h5>
                }
                ...
                <>
                    ...
                    <Carousel cols={3}
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                ...
                                <div class="card position-absolute top-0 start-0 card_width">
                                    ...
                                    <a onClick={handlecount1}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount2}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card position-absolute top-0 start-0 card_width">
                                    <a onClick={handlecount3}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount4}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card position-absolute top-0 start-0 card_width">
                                    <a onClick={handlecount5}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount6}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card card_width">
                                    <a onClick={handlecount7}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount8}><img width="48%" src="https://images6.fanpop.com/image/photos/42800000/The-Witcher-Season-1-Poster-Henry-Cavill-as-Geralt-of-Rivia-the-witcher-netflix-42889138-2400-1350.jpg" class="card-img-top rounded img_zoom" alt="..." />
                    ...
                    <div className="container-fluid mt-3">
                        <Carousel cols={3}
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    ...
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        ...
                                        <a onClick={handlecount1}><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text_1" id='ep1'>Episode 1</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount2}><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep2'>Episode 2</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount3}><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep3'>Episode 3</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount4}><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep4'>Episode 4</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount5}><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep5'>Episode 5</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount6}><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep6'>Episode 6</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card card_width">
                                        <a onClick={handlecount7}><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep7'>Episode 7</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount8}  ><img width="48%" src="https://i.ytimg.com/vi/NZ7sGKZtiT8/maxresdefault.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body decoration-remove">
                                                <p class="card-text text-center episode_slider_text" id='ep8'>Episode 8</p>
                                            </div>
                                        </a>
                    ...
                    <div className="container-fluid mt-3">
                        <Carousel cols={3}
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    ...
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        ...
                                        <a onClick={handlecount1}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text_1" id='ep1'>Episode 1</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount2}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep2'>Episode 2</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount3}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep3'>Episode 3</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount4}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep4'>Episode 4</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount5}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text " id='ep5'>Episode 5</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount6}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep6'>Episode 6</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card card_width">
                                        <a onClick={handlecount7}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep7'>Episode 7</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount8}  ><img width="48%" src="https://images6.fanpop.com/image/photos/43100000/The-Witcher-Season-1-Character-Poster-Freya-Allan-as-Ciri-the-witcher-netflix-43131557-1920-1080.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body decoration-remove">
                                                <p class="card-text text-center episode_slider_text" id='ep8'>Episode 8</p>
                                            </div>
                                        </a>
            ...
            <div className="container-fluid mt-3 mb-3">
                <Carousel cols={3}
                    ...
                    <Carousel.Item>
                        <div className='position-relative '>
                            ...
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                ...
                                <img src="https://media-manager.starsinsider.com/1080/na_5ab3ec768e50a.jpg" class="card-img-top mx-auto rounded-circle img-fluid" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-center text-white">Henry Cavill</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://networth.ai/wp-content/uploads/2020/07/anya-chalotra-witcher-wiki-age.jpg" class="card-img-top mx-auto rounded-circle img-fluid" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Anya Chalotra</p>
                                </div>
                            </div>
                    ...
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://i.pinimg.com/originals/aa/bb/f1/aabbf1158900d65b9838758ac1c521cc.jpg" class="card-img-top mx-auto rounded-circle img-fluid" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Freya Allan</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://marriedbiography.com/wp-content/uploads/2021/06/Joey-Batey.jpg" class="card-img-top mx-auto rounded-circle img-fluid" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Joey Batey</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card card_width_cast">
                                <img src="https://home.bt.com/images/myanna-buring-136419659026702601" class="card-img-top mx-auto rounded-circle img-fluid" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">MyAnna Buring</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://i0.wp.com/nubliner.com/wp-content/uploads/2022/03/MV5BNzMzMjBlNjQtNTBhYi00ZmQ5LWJhNzYtMDM3NzMwNjc1YjlhXkEyXkFqcGdeQXVyMjQwMDg0Ng@@._V1_-e1643899553703.jpg?fit=700%2C482&ssl=1" class="card-img-top mx-auto rounded-circle img-fluid" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center ">Eamon Farren</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
