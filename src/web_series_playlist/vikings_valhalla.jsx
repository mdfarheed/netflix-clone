        ...
        <>
            ...
            <div className="container-fluid mt-2">
                {count1 == 0 && seasonconut == 0 &&
                    <h5 class="text-white mb-3"> Vikings Valhalla | Season 1 | Episode 1</h5>
                }
                {seasonconut !=2 && count1 >= 1  && 
                    <h5 class="text-white mb-3"> Vikings Valhalla | Season 1 | Episode {count1}</h5>
                }
                {count2 == 0 && seasonconut ==2 &&
                    <h5 class="text-white mb-3"> Vikings Valhalla | Season 2 | Episode 1</h5>
                }
                {seasonconut !=1 && seasonconut !=0 && count2 >= 1 &&
                    <h5 class="text-white mb-3"> Vikings Valhalla | Season 2 | Episode {count2}</h5>
                }
                    ...
                    <div className="container-fluid mt-3">
                        <Carousel cols={3}
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    ...
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        ...
                                        <a onClick={handlecount1} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount2} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount3} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount4} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount5} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount6} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card card_width">
                                        <a onClick={handlecount7} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount8} ><img width="48%" src="https://dl.moviesr.net/images/3Kkce.jpg" class="card-img-top rounded img_zoom" alt="..." />
                    ...
                    <div className="container-fluid mt-3">
                        <Carousel cols={3}
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    ...
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        ...
                                        <a onClick={handlecount1} ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text_1" id='ep1'>Episode 1</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount2} ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep2'>Episode 2</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount3} ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep3'>Episode 3</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount4} ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep4'>Episode 4</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount5} ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text " id='ep5'>Episode 5</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount6}  ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep6'>Episode 6</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card card_width">
                                        <a onClick={handlecount7} ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep7'>Episode 7</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount8} ><img width="48%" src="https://imgeng.jagran.com/images/2023/jan/VikingsValahalla1673175422634.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body decoration-remove">
                                                <p class="card-text text-center episode_slider_text" id='ep8'>Episode 8</p>
                                            </div>
                                        </a>
            ...
            <div className="container-fluid mt-3 mb-3">
                <Carousel cols={3}
                    ...
                    <Carousel.Item>
                        <div className='position-relative '>
                            ...
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                ...
                                <img src="https://allureceleb.com/wp-content/uploads/2022/12/Sam-Corlett.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-center text-white">Sam Corlett</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://iv1.lisimg.com/image/28611331/740full-frida-gustavsson.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Frida Gustavsson</p>
                                </div>
                            </div>
                    ...
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://allureceleb.com/wp-content/uploads/2022/09/Leo-Suter-1.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Leo Suter</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://imgproxy.services.openhpi.de/k3cqJjsjljob0d7AcRLpOEh6qxpkpf5oTEO13JIlch8/rs:fit:0:0:0/g:ce/plain/https://imgproxy.services.openhpi.de/XjQGsJAiK21BW6PFeIzZIdOFo9TflhZ3TFL8AyzdFNk/rs:fit:550:0:0/g:ce/plain/https://opensap-public.s3.openhpicloud.de/teachers/2NxutLxQvco50hU5THuAJG/4Iz3X7SAC2jU0oMA3LoSwp/MichalRohnka.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Jóhannes Haukur</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://img-cdn.brainberries.co/wp-content/uploads/2019/08/Laura-Berlin.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Laura Berlin</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://www.famousbirthdays.com/headshots/david-oakes-1.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center ">David Oakes</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card card_width_cast">
                                <img src="https://moniquerhodes.com/wp-content/uploads/2023/10/Henrik.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Bradley Freegard</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://www.shropshirestar.com/resizer/ueLfIZcK6Bl511xFqIYOY9f0RfI=/1200x0/cloudfront-us-east-1.images.arcpublishing.com/mna/OQ5TIFZ525CEBIQMTAGD62HOSE.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">John Kavanagh</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://i.redd.it/fw61bidcjsr41.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Pollyanna</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://img.agecalculator.me/celeb-8753.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Bradley James</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
...
export default Vikings_Valhalla;