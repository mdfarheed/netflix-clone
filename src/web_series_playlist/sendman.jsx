...
const Sendman = () => {
    ...
    return (
        <>
            ...
            {count1 != 2 && count1 != 3 && count1 != 4 && count1 != 5 && count1 != 6 && count1 != 7 && count1 != 8 && count1 != 9 && count1 != 10 && count1 != 11 &&
                <>
            ...
            <div className="container-fluid mt-2">
                {count1 == 0 &&
                    <h5 class="text-white mb-3"> The Sendman | Season 1 | Episode 1</h5>
                }
                {count1 >= 1 &&
                    <h5 class="text-white mb-3"> The Sendman | Season 1 | Episode {count1}</h5>
                 }
                ...
                <div className="container-fluid mt-3">
                    <Carousel cols={3}
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                ...
                                <div class="card position-absolute top-0 start-0 card_width">
                                    ...
                                    <a onClick={handlecount1}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount2}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card position-absolute top-0 start-0 card_width">
                                    <a onClick={handlecount3}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount4}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card position-absolute top-0 start-0 card_width">
                                    <a onClick={handlecount5}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount6}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card card_width">
                                    <a onClick={handlecount7}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount8}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card card_width">
                                    <a onClick={handlecount9}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount10}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body decoration-remove">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card card_width">
                                    <a onClick={handlecount11}><img width="48%" src="https://wegotthiscovered.com/wp-content/uploads/2022/08/Poster-for-The-Sandman.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
            ...
            <div className="container-fluid mt-3 mb-3">
                <Carousel cols={3}
                    ...
                    <Carousel.Item>
                        <div className='position-relative '>
                            ...
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                ...
                                <img src="https://bookingagentinfo.com/wp-content/uploads/2022/10/Tom-Sturridge-1.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-center text-white">Tom Sturridge</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://media1.popsugar-assets.com/files/thumbor/qVe66XrlKxpfPid2goeZz7pPvEk/fit-in/1024x1024/filters:format_auto-!!-:strip_icc-!!-/2018/09/12/730/n/44285655/fad1ffe67dbebbd1_GettyImages-596012420/i/Sexy-Boyd-Holbrook-Pictures.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Boyd Holbrook</p>
                                </div>
                            </div>
                    ...
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://img.articlebio.com/uploads/biography/2020/07/28/danielle-vitalis-1595882053.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Kirby Howell-Baptiste</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://reductress.com/wp-content/uploads/2019/01/sandra_oh-820x722.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Sandra Oh</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card card_width_cast">
                                <img src="https://pyxis.nymag.com/v1/imgs/67b/fc3/8168cc7726c3d2afbc934e764816a3651b-22-gwendoline-christie.rsquare.w330.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Gwendoline Christie</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://superstarsbio.com/wp-content/uploads/2019/09/Patton-Oswalt-bio.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center ">Patton Oswalt</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
