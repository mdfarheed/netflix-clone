    ...
    return (
        <>
            ...
            <div className="container-fluid mt-2">
                {count1 == 0 &&
                    <h5 class="text-white mb-3"> Heeramandi | Season 1 | Episode 1</h5>
                }
                {count1 >= 1 &&
                    <h5 class="text-white mb-3"> Heeramandi| Season 1 | Episode {count1}</h5>
                 }
                ...
                <div className="container-fluid mt-3">
                    <Carousel cols={3}
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                ...
                                <div class="card position-absolute top-0 start-0 card_width">
                                    ...
                                    <a onClick={handlecount1}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount2}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card position-absolute top-0 start-0 card_width">
                                    <a onClick={handlecount3}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount4}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card position-absolute top-0 start-0 card_width">
                                    <a onClick={handlecount5}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount6}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                        ...
                        <Carousel.Item>
                            <div className='position-relative'>
                                <div class="card card_width">
                                    <a onClick={handlecount7}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                        <div class="card-body">
                                ...
                                <div class="card position-absolute top-0 start-50 card_width">
                                    <a onClick={handlecount8}><img width="48%" src="https://images.news18.com/ibnlive/uploads/2023/02/heeramandi-poster-167670908916x9.jpg" class="card-img-top rounded img_zoom" alt="..." />
            ...
            <div className="container-fluid mt-3 mb-3">
                <Carousel cols={3}
                    ...
                    <Carousel.Item>
                        <div className='position-relative '>
                            ...
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                ...
                                <img src="https://1.bp.blogspot.com/-gXkeEdA306Y/XVaVUNmlIOI/AAAAAAAAgZM/vvqXCTQsQxQSgXY4VzvXJWFWspQB3b03gCLcBGAs/s1600/1%2B%25286%2529.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-center text-white">Manisha Koirala</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://images.hindustantimes.com/rf/image_size_640x362/HT/p2/2016/05/09/Pictures/cafe_71deb082-15bb-11e6-952f-d19f9bc24ed8.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Sonakshi Sinha</p>
                                </div>
                            </div>
                    ...
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://images.herzindagi.info/image/2020/Jul/aditi-rao-hydari.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Aditi Rao Hydari</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://imagevars.gulfnews.com/2021/01/19/Richa-Chadha_1771a1828ac_original-ratio.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Richa Chadha</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://infopedia24.com/wp-content/uploads/Sharmin-Segal-Biography.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Sharmin Segal</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://images.hindustantimes.com/rf/image_size_800x600/HT/p2/2016/06/24/Pictures/sanjeeda-sheikh-actor_85d908ae-3a04-11e6-9ae1-15e7618d0e32.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center ">Sanjeeda Sheikh</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card card_width_cast">
                                <img src="https://superstarsculture.com/wp-content/uploads/2020/06/Anuj-Sharma.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Anuj Sharma</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://nettv4u.com/serialimages/s/h/e/k/h/a/shekhar-suman.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Shekhar Suman</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
