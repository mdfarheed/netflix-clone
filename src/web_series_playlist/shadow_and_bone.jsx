        ...
        <>
            ...
            <div className="container-fluid mt-2">
                {count1 == 0 && seasonconut == 0 &&
                    <h5 class="text-white mb-3"> Shadow And Bone | Season 1 | Episode 1</h5>
                }
                {seasonconut !=2 && count1 >= 1  && 
                    <h5 class="text-white mb-3"> Shadow And Bone | Season 1 | Episode {count1}</h5>
                }
                {count2 == 0 && seasonconut ==2 &&
                    <h5 class="text-white mb-3">  Shadow And Bone | Season 2 | Episode 1</h5>
                }
                {seasonconut !=1 && seasonconut !=0 && count2 >= 1 &&
                    <h5 class="text-white mb-3"> Shadow And Bone | Season 2 | Episode {count2}</h5>
                }
                    ...
                    <div className="container-fluid mt-3">
                        <Carousel cols={3}
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    ...
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        ...
                                        <a onClick={handlecount1} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount2} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount3} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount4} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount5} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount6} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card card_width">
                                        <a onClick={handlecount7} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount8} ><img width="48%" src="https://t3n9sm.c2.acecdn.net/wp-content/uploads/2021/05/Shadow-and-Bone.jpg" class="card-img-top rounded img_zoom" alt="..." />
                    ...
                    <div className="container-fluid mt-3">
                        <Carousel cols={3}
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    ...
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        ...
                                        <a onClick={handlecount1} ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text_1" id='ep1'>Episode 1</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount2} ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep2'>Episode 2</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount3} ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep3'>Episode 3</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount4} ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep4'>Episode 4</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card position-absolute top-0 start-0 card_width">
                                        <a onClick={handlecount5} ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text " id='ep5'>Episode 5</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount6}  ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep6'>Episode 6</p>
                                            </div>
                                        </a>
                            ...
                            <Carousel.Item>
                                <div className='position-relative'>
                                    <div class="card card_width">
                                        <a onClick={handlecount7} ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body">
                                                <p class="card-text text-center episode_slider_text" id='ep7'>Episode 7</p>
                                            </div>
                                        </a>
                                    ...
                                    <div class="card position-absolute top-0 start-50 card_width">
                                        <a onClick={handlecount8} ><img width="48%" src="https://scadconnector.com/wp-content/uploads/2021/04/Shadow-and-Bone-Netflix.jpg" class="card-img-top rounded img_zoom" alt="..." />
                                            <div class="card-body decoration-remove">
                                                <p class="card-text text-center episode_slider_text" id='ep8'>Episode 8</p>
                                            </div>
                                        </a>
            ...
            <div className="container-fluid mt-3 mb-3">
                <Carousel cols={3}
                    ...
                    <Carousel.Item>
                        <div className='position-relative '>
                            ...
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                ...
                                <img src="https://img.favebites.com/wp-content/uploads/2021/04/27085519/jessie-mei-li-1.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-center text-white">Jessie Mei Li</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://i.pinimg.com/originals/77/46/41/774641e42a7c5bb9b37321d5a5e03dd8.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Ben Barnes</p>
                                </div>
                            </div>
                    ...
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card position-absolute top-0 start-0 card_width_cast">
                                <img src="https://wealthyspy.com/wp-content/uploads/2021/04/Archie-Renaux-1-768x576.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Archie Renaux</p>
                                </div>
                            </div>

                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://thefamousinfo.com/wp-content/uploads/2023/05/Freddy-Carter-1.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Freddy Carter</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item>
                    <Carousel.Item>
                        <div className='position-relative'>
                            <div class="card card_width_cast">
                                <img src="https://healthyceleb.com/wp-content/uploads/2021/04/Amita-Suman-as-seen-in-an-Instagram-post-in-March-2021.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center">Amita Suman</p>
                                </div>
                            </div>
                            <div class="card position-absolute top-0 start-50 card_width_cast">
                                <img src="https://i.pinimg.com/736x/ac/d9/e6/acd9e6653799eb80dc91154483f9e6d2.jpg" class="card-img-top mx-auto rounded-circle" alt="..." />
                                <div class="card-body">
                                    <p class="card-text text-white text-center ">Kit Young</p>
                                </div>
                            </div>
                        </div>
                    </Carousel.Item> 
...
export default Shadow_And_Bone;